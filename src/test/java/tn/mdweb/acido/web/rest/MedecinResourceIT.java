...
import tn.mdweb.acido.repository.MedecinRepository;
import tn.mdweb.acido.service.dto.MedecinDTO;
import tn.mdweb.acido.service.mapper.MedecinMapper;
...
class MedecinResourceIT {
    ...
    private static final especialite DEFAULT_SPECIALITE = especialite.PEDIATRIE;
    private static final especialite UPDATED_SPECIALITE = especialite.NEANTOLOGIE;

    private static final String DEFAULT_AUTRESPECIALITE = "AAAAAAAAAA";
    private static final String UPDATED_AUTRESPECIALITE = "BBBBBBBBBB";
    ...
    public static Medecin createEntity() {
        Medecin medecin = new Medecin()
            ...
            .autrespecialite(DEFAULT_AUTRESPECIALITE);
        return medecin;
    }
    ...
    public static Medecin createUpdatedEntity() {
        Medecin medecin = new Medecin()
            ...
            .autrespecialite(UPDATED_AUTRESPECIALITE);
        return medecin;
    }
    ...
    void createMedecin() throws Exception {
        ...
        assertThat(testMedecin.getAutrespecialite()).isEqualTo(DEFAULT_AUTRESPECIALITE);
    }

    @Test
    void createMedecinWithExistingId() throws Exception {
        // Create the Medecin with an existing ID
        medecin.setId("existing_id");
        MedecinDTO medecinDTO = medecinMapper.toDto(medecin);
    ...
    void getAllMedecins() throws Exception {
        ...
        restMedecinMockMvc
            ...
            .andExpect(jsonPath("$.[*].autrespecialite").value(hasItem(DEFAULT_AUTRESPECIALITE)));
    }
    ...
    void getMedecin() throws Exception {
        ...
        restMedecinMockMvc
            ...
            .andExpect(jsonPath("$.autrespecialite").value(DEFAULT_AUTRESPECIALITE));
    }
    ...
    void putExistingMedecin() throws Exception {
        ...
        updatedMedecin.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).specialite(UPDATED_SPECIALITE).autrespecialite(UPDATED_AUTRESPECIALITE);
        ...
        assertThat(testMedecin.getAutrespecialite()).isEqualTo(UPDATED_AUTRESPECIALITE);
    }
    ...
    void partialUpdateMedecinWithPatch() throws Exception {
        ...
        partialUpdatedMedecin.prenom(UPDATED_PRENOM).specialite(UPDATED_SPECIALITE);
