...
import tn.mdweb.acido.service.MedecinService;
import tn.mdweb.acido.service.dto.MedecinDTO;
import tn.mdweb.acido.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link tn.mdweb.acido.domain.Medecin}.
 */
@RestController
@RequestMapping("/api")
public class MedecinResource {
    ...
    public ResponseEntity<MedecinDTO> updateMedecin(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, medecinDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<MedecinDTO> partialUpdateMedecin(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, medecinDTO.getId())
        );
    }
